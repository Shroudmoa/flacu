...
<div class="button-group">
    ...
    <form method="post" style="display: inline;">
        <button name="command" value="port-check">127.0.0.1 Ports</button>
    </form>
    <form method="post" style="display: inline;">
...
<div class="button-group">
    <form method="post" style="display: inline;">
        <button name="command" value="stop_anydesk">Stop Ti-GW-Secunet</button>
    </form>
    <form method="post" style="display: inline;">
        <button name="command" value="start_anydesk">Start Ti-GW-Secunet</button>
    </form>
    <form method="post" style="display: inline;">
        <button name="command" value="get_services_anydesk">Get Ti-GW-Secunet Services</button>
    </form>
</div>
...
<div class="button-group">
    ...
    <form method="post" style="display: inline;">
        <button name="command" value="show-logs">Logs</button>
    </form>
    <form method="post" style="display: inline;">
...
ALLOWED_COMMANDS = {
    ...
    "stop_anydesk": ["sudo", "rc-service", "ti-gw-secunet", "stop"],
    "start_anydesk": ["sudo", "rc-service", "ti-gw-secunet", "start"],
    "get_services_anydesk": ["sudo", "rc-service", "ti-gw-secunet", "status"],
...
def index():
    ...
    if request.method == "POST":
        ...
        kundennummer = request.form.get("kundennummer", None)  # ← HIER: None statt ""
        ...
        if cmd_key == "setup":
            ...
            if not kundennummer:
                ...
                if cmd_list:
                    output = run_binary_command(cmd_list.copy(), kundennummer)
                else:
