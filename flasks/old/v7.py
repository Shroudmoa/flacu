...
def index():
    ...
    if request.method == "POST":
        ...
        if cmd_key == "setup":
            if not kundennummer or kundennummer == "":
                output = "Error: Kundennummer is required for setup. Please enter a customer number."
            else:
            ...
            cmd_list = ALLOWED_COMMANDS[cmd_key].copy()
